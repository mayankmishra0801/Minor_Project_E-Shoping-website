...
def topwear(request, data=None):
	...
	if data==None :
			...
			topwears = Product.objects.filter(category='L').filter(brand=data)
	elif data == 'below':
			topwears = Product.objects.filter(category='L').filter(discounted_price__lt=10000)
	elif data == 'above':
			topwears = Product.objects.filter(category='L').filter(discounted_price__gt=10000)
...
def bottomwear(request, data=None):
	...
	if request.user.is_authenticated:
		totalitem = len(Cart.objects.filter(user=request.user))
	if data==None :
			bottomwears = Product.objects.filter(category='L')
	elif data == 'Jens' or data == 'Paint':
			bottomwears = Product.objects.filter(category='L').filter(brand=data)
	elif data == 'below':
			bottomwears = Product.objects.filter(category='L').filter(discounted_price__lt=10000)
	elif data == 'above':
			bottomwears = Product.objects.filter(category='L').filter(discounted_price__gt=10000)
